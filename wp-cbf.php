 ...
 *
 * @link              http://huchka.github.io/
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and base Functions
 * Plugin URI:        https://github.com/huchka/test-plugin-001.git
 * Description:       Head nanchyara. This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            huchka
 * Author URI:        http://huchka.github.io/
 * License:           GPL-2.0+
